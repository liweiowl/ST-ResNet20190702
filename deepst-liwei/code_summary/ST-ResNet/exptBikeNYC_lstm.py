...
from ST_ResNet import stresnet, stresnet_lstm
...
def build_model(external_dim):
    ...
    model = stresnet_lstm(c_conf=c_conf, p_conf=p_conf, t_conf=t_conf,
                     external_dim=external_dim, nb_residual_unit=nb_residual_unit)
    adam = Adam(lr=lr)
    myoptim = Nadam(lr=lr)
    model.compile(loss='mse', optimizer=myoptim, metrics=[metrics.rmse])
    model.summary()

...
# sys.path.append('C:\\Users\\user\\Anaconda3\\Lib\\site-packages\\DeepST-0.0.1-py3.6.egg\\deepst')
from preprocessing import load_stdata
from preprocessing import MinMaxNormalization
from preprocessing import remove_incomplete_days
from preprocessing import timestamp2vec,Config
from preprocessing import STMatrix
np.random.seed(1337)  # for reproducibility

# parameters
# DATAPATH = Config().DATAPATH

DATAPATH = './data/BikeNYC/'
...
def load_data(T=24, nb_flow=2, len_closeness=None, len_period=None, len_trend=None, len_test=None, preprocess_name='preprocessing.pkl', meta_data=True):
    ...
    # data, timestamps = load_stdata('BikeNYC'+'/'+'NYC14_M16x8_T60_NewEnd.h5')
    data, timestamps = load_stdata(DATAPATH+'NYC14_M16x8_T60_NewEnd.h5')
...
if __name__ == '__main__':
    data, timestamps = load_stdata('./data/BikeNYC'+'/'+'NYC14_M16x8_T60_NewEnd.h5')
    print('love world')